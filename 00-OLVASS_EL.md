# Irodai szabvány — mi ez a mappa?

**Ez a mappa tartja a Medek Mérnöki Iroda Kft. irodai szabványát:** hogyan
...
| | |
|---|---|
| **Használat** — sablont nyitok, elolvasom a szabványt, új projektet indítok | `01-Segedletek/`, `02-Sablonok/`, `03-Eszkozok/` |
| **Karbantartás** — magát a szabványt módosítom | `_tool/`, és általában Claude-dal együtt |

A kettő szándékosan van szétválasztva. A `_tool/` mappa nem titkos és nem
tiltott — csak nem oda kell nyúlni ahhoz, hogy valaki *használja* a szabványt.
...
| `Projekt_migracio.md` | Hogyan viszel át egy már elindult projektet a szabványra. |
...
- `Uj_projekt.bat` — új projektmappa létrehozása a szabvány szerint
- `Uj_muleiras.bat` — új műleírás indítása egy meglévő projektben
- `Sablonok_ujraepitese.bat` — a sablonok újraépítése, ha a szabvány változott
...
előzmény. **Ide akkor nyúlj, ha magát a szabványt akarod módosítani** — és
...
A teljes szabvány verziókövetett és fel van töltve ide:
